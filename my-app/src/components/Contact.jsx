        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div>
            ...
            <p className="text-lg text-gray-300 mb-8">
              Have questions about StreamLive? Need help with your streaming setup? 
              We're here to help you create amazing live experiences.
            </p>
            ...
            <div className="space-y-6">
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-gray-300">support@streamlive.com</p>
                </div>
              </div>
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-gray-300">+91 7586******</p>
                </div>
              </div>
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-gray-300">123 Cyber City<br />Gurugram , 122001</p>
                </div>
              </div>
            </div>
            ...
            <div onSubmit={handleSubmit} className="space-y-6">
              <div>
                <label 
                  ...
                  style={{color: '#d1d5db'}} // Fallback inline style
                >
                  Full Name
                </label>
                <input
              ...
              <button
                ...
                className="w-full bg-orange-500 text-white font-medium py-3 px-6 rounded-lg hover:bg-orange-600 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 focus:ring-offset-gray-800"
              >
                Send Message
              </button>
            </div>
